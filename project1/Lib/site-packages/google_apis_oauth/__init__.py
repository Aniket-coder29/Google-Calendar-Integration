...
def stringify_credentials(credentials):
    ...
    # pickle.dump(credentials_dict,open('token.pkl','wb'))
...
def load_credentials(stringified_credentials):
    ...
    Returns:
        Credentials: The credentials object which can be used to authenticate google APIs.
    """
    # with open(stringified_credentials, 'r') as j:
    #     credentials_dict = json.loads(j.read())
    # credentials_dict = json.loads(stringified_credentials)

    # credentials_dict = pickle.load(open('token.pkl','rb'))
    credentials_dict = stringified_credentials
